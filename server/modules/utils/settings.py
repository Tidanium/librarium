...
try:
  ...
  configData = config.read('config.ini') if create else print("Failed to create config.ini which is essential to the operations of the server. Please confirm write permissions are granted and try again.") and exit(1)
